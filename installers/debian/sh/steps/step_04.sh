...
# ERRATA OAUTH CLIENT ID
export ERRATA_OAUTH_CLIENT_ID=XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX

# ERRATA OAUTH CLIENT SECRET
export ERRATA_OAUTH_CLIENT_SECRET =XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX

# ERRATA GH ACCESS TOKEN
export ERRATA_GITHUB_ACCESS_TOKEN=XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
